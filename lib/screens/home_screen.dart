            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: PageView(
                  ...
                  children: List.generate(
                    MyJson().recommendationsData.length,
                    (int index) => GestureDetector(
                      onTap: () {
                        // Navigator.of(context).push(
                        //   MaterialPageRoute(
                        //     builder: (context) => SelectedPlaceScreen(
                        //       recommendedModel: recommendations[index], description: null, images: null, name: null, price: null, tagLine: null,
                        //     ),
                        //   ),
                        // );
                      },
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            fit: BoxFit.cover,
                            image: NetworkImage(MyJson().recommendationsData[index].image!),
                          ),
                        ),
                        child: Stack(
                          children: <Widget>[
              ...
              Padding(
                ...
                child: SmoothPageIndicator(
                  controller: _pageController,
                  count: MyJson().recommendationsData.length,
